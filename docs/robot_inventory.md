...
|---|---|---|---|---|---|---|---|---|---|
| **G1** | Unitree 7520-22.5 (knee/hip_roll), **7520-14.3 (hip_pitch/hip_yaw)**, 5020 (ankle) | **knee 22.5:1; hip_pitch 14.3:1** (NOT 22.5) | ~2.3 *(estimate)* | ~0.013 *(estimate)* | team ~0.0025 *(optimistic edge of band 0.001–0.020; BEST ≈ 0.0024 knee / 0.0059 hip_pitch per g1_motor_constants.md — NOT 8–19× wrong)* | hip_pitch ±88, hip_roll/knee ±139, ankle ±50 | hip 32, knee 20, ankle 30 | QDD planetary, backdrivable | **LOW** — no primary G1 Kt/R |
...
|---|---|---|---|
| **G1** | Kt, R have NO primary source; team values estimate-only & optimistic | **YES** — no primary G1 Kt/R; report R/Kt² as band 0.001–0.020 (g1_motor_constants.md), code value at the optimistic edge | **hip_pitch is 14.3:1, not 22.5:1** (team CLAUDE.md/RESULTS wrong). hip_roll is 139 not 88. OmniXtreme does NOT corroborate 14.3 (it says 22.5) — local armature pins it. |
